#!/usr/bin/env python3
"""
Migration script runner for Houzdey backend.
...
async def migrate_existing_properties():
    ...
    print(f"\nMigration completed!")
    print(f"Successfully migrated {migrated_count} out of {len(properties_to_migrate)} properties")
...
async def main():
    ...
    print("🏠 Houzdey Property Migration Script")
    print("=" * 50)
    
    try:
        # Run migration
        await migrate_existing_properties()
